...
import { IIcon } from '@/utils/helpers';
...
.btn {
  @apply px-4 py-3 rounded-lg shadow-lg
    bg-pure-white dark:bg-secondary hover:text-white hover:bg-tertiary dark:hover:bg-tertiary dark:hover:text-[rgb(0,0,0)] transition;
}
</style>
